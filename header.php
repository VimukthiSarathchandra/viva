...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center fixed-top ">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-center justify-content-lg-start">
            <i class="bi bi-phone d-none d-lg-flex align-items-center"><span>+94 77 4573 791</span></i>
            ...
            ?>
                <a href="profile.php"><i class="bi bi bi-person-circle ms-4 align-items-center"><span><?php echo $data["fname"] . " " . $data["lname"]; ?></span></i></a>
            <?php

            } else {

            ?>
                <a href="#"><i class="bi bi-person-fill ms-4 d-none d-lg-flex align-items-center" onclick="show();"><span>Log In</span></i></a>
            <?php

            }

            ?>
            <a href="contact.php"><i class="bi bi-phone ms-4 d-flex align-items-center"><span>Contact</span></i></a>
            <!-- <a href="profile.php"><i class="bi bi-person-circle ms-4 d-flex align-items-center"><span>My Profile</span></i></a> -->
        </div>
    </section>
    ...
    <header id="header" class="fixed-top d-flex align-items-center ">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <div class="logo me-lg-5 me-auto">
            ...
            <nav class="navbar order-last order-lg-0">
                ...
                <ul>
                    <li class="dropdown"><a href="#"><span>Categories</span> <i class="bi bi-chevron-down me-5"></i></a>
                        <ul>
                            <?php
                            ...
                            ?>
                                ...
                                <li><a href="#" onclick='allProduct(<?php echo $category_data["id"]; ?>, 0);' value="<?php echo $category_data["id"]; ?>"><?php echo $category_data["category"]; ?></a></li>
            ...
            <input type="text" class="form-control me-2 d-none d-lg-block" placeholder="Type Keyword to search..." id="basic_search_txt">
            <button class="btn btn-primary d-none d-lg-block me-5"  onclick="basicSearch(0);">Search</button>


            <nav id="navbar" class="navbar order-last order-lg-0">

                <ul>
                    <li><a class="nav-link scrollto" href="#" onclick="cart();"><i class="bi bi-cart3 fs-4 text-danger"></i>Cart</a></li>
                    <li><a class="nav-link scrollto" href="#" onclick="watchlist();"><i class="bi bi-suit-heart fs-4 text-danger"></i>Watchlist</a></li>
                </ul>
            ...
            ?>
                <a href="#" class="book-a-table-btn scrollto d-lg-none" onclick="signout();">Log Out</a>
            <?php

            } else {

            ?>
                <a href="#" class="book-a-table-btn scrollto d-lg-none" onclick="show();">Log in</a>
            <?php
